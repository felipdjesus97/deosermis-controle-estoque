...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08/01/2026 às 18:15
...
DROP TABLE IF EXISTS `entradadeproduto`;
...
DROP TABLE IF EXISTS `fotodoproduto`;
...
DROP TABLE IF EXISTS `reposicaoproduto`;
...
DROP TABLE IF EXISTS `reposicao_entrada`;
...
DROP TABLE IF EXISTS `saidadeproduto`;
